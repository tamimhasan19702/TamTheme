...
while (have_posts()) {
    ...
    <div class="container container--narrow page-section">
        ...
        <div class="create-note">
            <div class="headline headline--medium">Create New Note</div>
            <input type="text" class="new-note-title" placeholder="Title">
            <textarea class="new-note-body" placeholder="Your note here..."></textarea>
            <span class="submit-note">Create Note</span>
            <span class="note-limit-message">Maximum 4 note limit reached. Please delete an existing note to make room for a
                new one</span>
        </div>
